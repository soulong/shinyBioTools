...
fluidRow(
    column(2,
           wellPanel(
             ...
             radioButtons(ns("shrna.type"), "Input Type", c("symbol", "ensembl_gene_id", "enterzgene"), "symbol"),
             ...
             hr(),
             actionButton(ns("shrna.submit"), "Submit Genes"),
             br(),br(),
             actionButton(ns("shrna.design"), "Design Primers"),
             br(),br(),
             downloadButton(ns("shrna.dl_primer"), "Download Primers")
           ) # end of wellpanel
    ),
    column(10,
